...
Batching by file and by single type is the forcing function: you cannot dispatch until you have decomposed the work, and that decomposition is the modeling. Settle what the record and the cards settle; pass upward only a product judgment, a change to the doctrine itself, or an action that is irreversible or costs money.
