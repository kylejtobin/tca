---
name: tca-construct-value-object
...
```json
{"construct": "value object", "name": "Spread", "file": "value.py", "fields": {"best_bid": "Price", "width": "SpreadWidth"}}
```

Every field value names a declared scalar or value object row.
