---
name: tca-construct-contract-model
...
```json
{"construct": "contract model", "name": "OrderRequest", "file": "api.py", "fields": {"product": "ProductId", "side": "OrderSide", "quantity": "Quantity", "price": "Price"}}
```

Every field value names a declared row from this context or a peer context. Contract rows live in the context's `api.py`.
