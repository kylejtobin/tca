---
name: tca-construct-semantic-scalar
...
```json
{"construct": "semantic scalar", "name": "Price", "file": "type.py", "primitive": "Decimal", "constraint": "gt=0, decimal_places=8"}
{"construct": "semantic scalar", "name": "OrderSide", "file": "type.py", "value_space": "Side", "members": ["buy", "sell"]}
{"construct": "semantic scalar", "name": "OrderNote", "file": "type.py", "primitive": "str", "openness": "any text, including empty, is a legal note"}
```

An open scalar carries `primitive` with `constraint`, or `openness` stating the docstring's reason when the open range is the domain fact. A closed vocabulary carries `value_space` and `members`.
