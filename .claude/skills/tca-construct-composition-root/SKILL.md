---
name: tca-construct-composition-root
...
```json
{"construct": "composition root", "name": "Main", "file": "main.py"}
```

The row carries no cells beyond name and file: everything the root does is derivable from the config, binding, consistency model, and route rows it wires.
