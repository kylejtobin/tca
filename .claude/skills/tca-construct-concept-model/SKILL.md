---
name: tca-construct-concept-model
...
```json
{"construct": "concept model", "name": "Fill", "file": "fill.py", "fields": {"order_id": "OrderId", "account_id": "AccountId", "fill_price": "Price", "filled_quantity": "Quantity"}}
{"construct": "concept model", "name": "QuoteSubscription", "file": "quote.py", "fields": {"product": "ProductId", "depth": {"type": "BookDepth", "default": "50"}}}
{"construct": "concept model", "name": "Position", "file": "position.py", "fields": {"prior": "PositionState", "fill": "Fill"}, "kind": {"axis": "PositionKind", "member": "open"}}
```

Every field value names a declared row, or `{"type": T, "default": "<value>"}` for a defaulted field whose default states what omission means and renders as `T(<value>)`. A union variant adds `kind`, pinning exactly one axis member.
